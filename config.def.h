...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_CTRL, 	XKB_KEY_p,      spawn,          SHCMD("flameshot gui --raw | wl-copy") },
	{ 0,         					XKB_KEY_Print, 	spawn, 			SHCMD("flameshot full -p $HOME/ims/$(data)") },
